...
// Class:      D0Fitter
// 
/**\class D0Fitter D0Fitter.cc RecoVertex/D0Producer/src/D0Fitter.cc
...
// $Id: D0Fitter.cc,v 1.56 2011/12/23 08:13:39 innocent Exp $
//
//
...
const float piMassSquared = piMass*piMass;
const float protonMass = 0.938272013;
const float protonMassSquared = protonMass*protonMass;
const float kaonMass = 0.493677;
const float kaonMassSquared = kaonMass*kaonMass;
const float kShortMass = 0.497614;
const float lambdaMass = 1.115683;
const float d0Mass = 1.86484;
...
//      TransientTrack tmpTk( *tmpRef, &(*bFieldHandle), globTkGeomHandle );
  ...
  float posCandMass[2] = {piMass, kaonMass};
  float negCandMass[2] = {kaonMass, piMass};
  float posCandMass_sigma[2] = {piMass_sigma, kaonMass_sigma};
  float negCandMass_sigma[2] = {kaonMass_sigma, piMass_sigma};
